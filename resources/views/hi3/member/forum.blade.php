@section('title', 'Community Forum - Honkai Impact 3rd | HoshiLab')
...
<div class="card text" style="background:black;">
    ...
    <br/>
        <div style="display: flex">
            <form class="d-flex" role="search" style="margin-right: 30px" action="{{ route('Search Forum Honkai Member') }}">
                <input class="form-control me-2" name="search" type="search" placeholder="Search" aria-label="Search" style="width: 300px">
                <button class="btn btn-outline-success" type="submit">Cari</button>
              </form>
              <a href="{{ route('Create Post Honkai Member Page') }}" class="btn btn-outline-success">Buat Posting</a>
        </div><br/><br/>
        <div class="row row-cols-1 justify-content-center">
            <div class="card-transparent" style="width: 75%; color:white; border:1px solid white; margin-top: 10px;">
                <div class="row no-gutters">
                    <div class="col-auto">
                            <a href="{{ route('View Honkai Post Zero Member') }}">
                                <img src="{{asset('storage/posthonkaiimage/admin.jpg')}}" class="img-fluid" alt="" style="width:12rem; margin-top: 15px; margin-bottom: 5px;">
                            </a>
                    </div>
                    <div class="col">
                        <div class="card-block px-2" style="text-align: left; margin-top:10px;">
                            <a class="card-title" href="{{ route('View Honkai Post Zero Member') }}" style="font-weight: 600; font-size: 23px; text-decoration: none; color: white">Pesan dari Admin</a>
                            <p class="card-text">Hai! Admin Hoshi disini!<br/>
                                Selamat datang di forum komunitas HoshiLab untuk game Honkai Impact 3!</p>
            ...
            <div class="card-transparent" style="width: 75%; color:white; border:1px solid white; margin-top: 10px;">
                <div class="row no-gutters">
                    <div class="col-auto">
                        @if ($pos->image != null)
                            <a href="{{ route('View Honkai Post Member', [$pos->id]) }}">
                                <img src="{{asset('storage/posthonkaiimage/'.$pos->image)}}" class="img-fluid" alt="" style="width:12rem; margin-top: 15px; margin-bottom: 5px;">
                            </a>
                        @endif
                    </div>
                    <div class="col">
                        <div class="card-block px-2" style="text-align: left; margin-top:10px;">
                            <a class="card-title" href="{{ route('View Honkai Post Member', [$pos->id]) }}" style="font-weight: 600; font-size: 23px; text-decoration: none; color: white">{{ $pos->title }}</a>
                            @if ($pos->image != null)
