@section('title', $forum->title. ' - Honkai Impact 3rd | HoshiLab')
...
<div class="card text-center" style="background:black;">
    ...
    <br/><br/><br/><br/>
    <a href="{{ route('Member Honkai Forum Page') }}" class="btn btn-outline-light" style="float: center;"><</a><br/><br/>
    ...
    @if ($forum->user_id == $user)
        <div style="display: flex; justify-content: center">
            <a href="{{ route('Edit Post Honkai Member Page', [$forum->id]) }}" class="btn btn-outline-primary">Edit</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="post" action="{{ route('Delete Post Honkai Member', [$forum->id]) }}">
                        @csrf
                        @method('delete')
    ...
    @else
        <div style="display: flex; justify-content: center">
            <a href="{{ route('Create Report Honkai Member Page', [$forum->id]) }}" class="btn btn-outline-danger">Report</a>
        </div>
    @endif
    <br/>
        ...
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            <div class="card-body" style="color:White; text-align:justify;">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form action="{{route('Create Comment on Post Honkai Member', $forum->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
