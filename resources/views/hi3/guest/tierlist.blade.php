...
<div class="card text-center" style="background:black;">
    ...
    <div class="row row-cols-3 justify-content-md-center">
        ...
        <div class="card-transparent" style="width: 18rem;">
            <a href="{{ route('View Character Guest', [$spt->id]) }}">
    ...
    <div class="row row-cols-3 justify-content-md-center">
        @foreach($stier as $st)
        <div class="card-transparent" style="width: 18rem;">
            <a href="{{ route('View Character Guest', [$st->id]) }}">
    ...
    <div class="row row-cols-3 justify-content-md-center">
        @foreach($atier as $at)
        <div class="card-transparent" style="width: 18rem;">
            <a href="{{ route('View Character Guest', [$at->id]) }}">
    ...
    <div class="row row-cols-3 justify-content-md-center">
        @foreach($btier as $bt)
        <div class="card-transparent" style="width: 18rem;">
            <a href="{{ route('View Character Guest', [$bt->id]) }}">
    ...
    <div class="row row-cols-3 justify-content-md-center">
        @foreach($ctier as $ct)
        <div class="card-transparent" style="width: 18rem;">
            <a href="{{ route('View Character Guest', [$ct->id]) }}">
