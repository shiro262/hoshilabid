...
<div class="card text" style="background:black;">
    ...
    <br/>
        <div style="display: flex">
            <form class="d-flex" role="search" style="margin-right: 30px" action="{{ route('Search Blog Admin') }}">
        ...
        <div class="card-transparent" style="color:white;">
          ...
          <div class="card-body">
              <a class="card-title" href="{{ route('View Blog Admin', [$bg->id]) }}" style="font-weight: 600; font-size: 20px; text-decoration: none; color: white">{{ $bg->title }}</a>
