...
<div class="card text-center" style="background:black;">
    ...
    <br/><br/><br/>
    <a href="{{ route('Admin Guide Page') }}" class="btn btn-outline-light" style="float: center;"><</a><br/><br/>
    <a href="{{ url('/admin/guideupdate/'.$guides->id) }}" class="btn btn-outline-primary" style="float: center;">Edit</a><br/><br/>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Delete Guide</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              Are you sure want to delete this guide?
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <form method="post" action="{{route('Delete Guide', [$guides->id])}}">
                  @csrf
                  @method('delete')
