        ...
        <div class="row row-cols-1 justify-content-center">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col">
                        <div class="card-block px-2" style="text-align: left; margin-top:10px;">
                            <a class="card-title" href="{{ route('View Honkai Post Zero admin') }}" style="font-weight: 600; font-size: 23px; text-decoration: none; color: white">Pesan dari Admin</a>
            ...
            <div class="card-transparent" style="width: 75%; color:white; border:1px solid white; margin-top: 10px;">
                <div class="row no-gutters">
                    <div class="col-auto">
                        @if ($pos->image != null)
                            <a href="{{ route('View Honkai Post admin', [$pos->id]) }}">
                    ...
                    <div class="col">
                        <div class="card-block px-2" style="text-align: left; margin-top:10px;">
                            <a class="card-title" href="{{ route('View Honkai Post admin', [$pos->id]) }}" style="font-weight: 600; font-size: 23px; text-decoration: none; color: white">{{ $pos->title }}</a>
                            @if ($pos->image != null)
