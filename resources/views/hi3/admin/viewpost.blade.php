@section('title', $forum->title. ' - Honkai Impact | HoshiLab')
...
<div class="card text-center" style="background:black;">
    ...
    <br/><br/><br/><br/>
    <a href="{{ route('admin Honkai Forum Page') }}" class="btn btn-outline-light" style="float: center;"><</a><br/><br/>
    ...
    @endif
        <div style="display: flex; justify-content: center">
            @if ($forum->user_id == $user)
                <a href="{{ route('Edit Post Honkai admin Page', [$forum->id]) }}" class="btn btn-outline-primary">Edit</a>
                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-left: 30px">
                    Hapus
                </button><br/>
            @else
                <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" style="">
                    Hapus
                </button><br/>
            @endif
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="post" action="{{ route('Delete Post Honkai admin', [$forum->id]) }}">
                        @csrf
                        @method('delete')
    ...
    <div class="col d-flex justify-content-center">
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            @if ($forum->image != null)
                <img src="{{asset('storage/posthonkaiimage/'.$forum->image)}}" style="width: 35rem;">
            @endif
            <div class="card-body" style="color:White; text-align:justify;">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form action="{{route('Create Comment on Post Honkai admin', $forum->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
