...
<div class="card text-center" style="background:black;">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
              <form class="d-flex my-2 my-lg-0" action="{{ route('Search Weapon admin') }}">
                @if(isset($query))
    ...
    @else
        ...
        <a class="btn btn-transparent" href="{{ route('admin Weapon Rocket Hammer Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/weapontype_honkai/Rocket Hammers.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Weapon Scythe Page') }}" role="button">
    ...
    <div class="col d-flex justify-content-center">
        <table class="table w-50 p-3" style="border:1px solid white;">
            ...
            @foreach ($weapon as $wea)
              <tr style="color: white; text-align: left;">
                <td>
                    <a href="{{ route('View Weapon admin', [$wea->id]) }}">
