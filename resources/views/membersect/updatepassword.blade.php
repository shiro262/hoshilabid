    ...
    <div class="container mt-4">
        <div class="card-transparent">
          ...
          <div class="card-body" style="color: white;">
            <form class="insert-page-container" method="POST" enctype="multipart/form-data" action="{{route('Update Password Member')}}">
                @csrf
                @if ($errors->any())
                ...
                <br/>
                <a href="{{url('member/profile')}}" class="btn btn-outline-light" style="color:white;"><</a>
            </form>
          </div>
        </div>
      </div>
