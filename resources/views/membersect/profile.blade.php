        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-12 text-center">
                    <a href="{{ url('/member/profileupdate/'.$profiles->id) }}" class="btn btn-outline-primary">Edit Profile</a>
                    <a href="{{ url('/member/passwordupdate/'.$profiles->id) }}" class="btn btn-outline-primary">Edit Password</a>
                </div>
            </div>
        </div>
    </div>
