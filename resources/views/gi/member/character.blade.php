...
<div class="card text-center" style="background:black;">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
              <form class="d-flex my-2 my-lg-0" action="{{ route('Search Character Genshin Member') }}">
                @if(isset($query))
    ...
    <div class="card-transparent" style="width: 19rem;">
        <a href="{{ route('View Character Genshin Member', [$c->id]) }}">
