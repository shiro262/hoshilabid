            ...
            <div class="card-body" style="color:White; text-align:justify;">
                <p class="card-text">
                    ...
                    <hr style="height:10px; border-width:1px; color:white; margin-top:3px; margin-bottom:0px;">
                        Opsi Terbaik:<br/>
                        <a href="{{ route('View Weapon Genshin Member', [$chara->signweapon->id]) }}">
                        ...
                        <br/>
                        Alternatif:<br/>
                        <a href="{{ route('View Weapon Genshin Member', [$chara->alt1weapon->id]) }}">
                        ...
                        <br/>
                        <a href="{{ route('View Weapon Genshin Member', [$chara->alt2weapon->id]) }}">
                        ...
                        <hr style="height:10px; border-width:1px; color:white; margin-top:3px; margin-bottom:0px;">
                        Opsi 1:<br/>
                        <a href="{{ route('View Artifact Member', [$chara->artifactoption1->id]) }}">
                        ...
                        <br/>
                        Opsi 2:<br/>
                        <a href="{{ route('View Artifact Member', [$chara->artifactoption2->id]) }}">
