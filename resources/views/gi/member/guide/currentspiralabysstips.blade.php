                ...
                <p class="card-text">
                    ...
                    <ul>
                        <li>
                            ...
                            Alternatif:<br/>
                            <a href="{{ route('View Character Genshin Member', [31]) }}">
                        ...
                        <li>
                            ...
                            Alternatif:<br/>
                            <a href="{{ route('View Character Genshin Member', [62]) }}">
