@section('title', 'Create Post - Genshin Impact | HoshiLab')
...
<div class="card text" style="background:black;">
    ...
    <div style="display: flex; justify-content: center; color: white">
        <form method="post" enctype="multipart/form-data" action="{{ route('Create Post Genshin Member') }}" style="width: 600px">
            @csrf
            <div class="mb-3">
