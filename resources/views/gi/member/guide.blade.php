...
<div class="card text-center" style="background:black;">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Intro to Game Page') }}">
        ...
        <div class="card-transparent" style="width: 32rem;">
            <a href="{{ route('Genshin Member Guide Early Game Tips Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Elemental Reaction Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Team Building Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Character Upgrade Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Gacha System Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide F2P Gacha Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Should u Pull Current Banner Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Member Guide Intro to Spiral Abyss Page') }}">
        ...
        <div class="card-transparent" style="width: 27rem;">
            <a href="{{ route('Genshin Member Guide Current Spiral Abyss Tips Page') }}">
