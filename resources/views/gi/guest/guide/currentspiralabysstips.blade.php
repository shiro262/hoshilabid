                ...
                <p class="card-text">
                    ...
                    <ul>
                        <li>
                            ...
                            Alternatif:<br/>
                            <a href="{{ route('View Character Genshin Guest', [31]) }}">
                        ...
                        <li>
                            ...
                            Alternatif:<br/>
                            <a href="{{ route('View Character Genshin Guest', [62]) }}">
