              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <h4 class="fw-normal mb-1 pb-1" style="letter-spacing: 1px; text-align:left; color:White;">
                        ...
                        Signature:<br/>
                        <img style="height:50px;border-width:50px;" src="{{asset('storage/weaponimagegenshin/'.$chara->bestweapon->image)}}">  {{$chara->bestweapon->name}}
                        <br/>
                        Alternative:
                    </h4>
                    <hr style="height:10px; border-width:10px;">
                    <h4 class="fw-normal mb-1 pb-1" style="letter-spacing: 1px;text-align:left; color:White;">
                        ...
                        <hr style="height:10px; border-width:10px; color:blue;">
                        Signature:<br/>
                        <img style="height:75px;border-width:75px;" src="{{asset('storage/artifactimage/'.$chara->bestartifact->Image)}}"> {{$chara->bestartifact->name}}
                        <br/>
                        Alternative:
                    </h4>
