    ...
    <br/><br/>
      ...
      <div class="row row-cols-3 justify-content-md-center">
        <div class="card-transparent" style="width: 20rem;">
          <a href={{ route('Guest Genshin Guide Page') }}>
        ...
        <div class="card-transparent" style="width: 20rem;">
          <a href="{{ route('Guest Character Genshin Page') }}">
        ...
        <div class="card-transparent" style="width: 20rem;">
          <a href={{ route('Guest Tier List Genshin Page') }}>
        ...
        <div class="card-transparent" style="width: 20rem;">
          <a href={{ route('Guest Genshin News Page') }}>
