...
<div class="card text-center" style="background:black;">
    ...
    <div class="row row-cols-3">
        ...
        <div class="card-transparent" style="width: 32rem;">
            <a href="{{ route('Genshin Guest Guide Early Game Tips Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Elemental Reaction Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Team Building Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Character Upgrade Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Gacha System Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide F2P Gacha Page') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Should u Pull Current Banner Page') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Genshin Guest Guide Intro to Spiral Abyss Page') }}">
        ...
        <div class="card-transparent" style="width: 27rem;">
            <a href="{{ route('Genshin Guest Guide Current Spiral Abyss Tips Page') }}">
