                ...
                <p class="card-text">
                    ...
                    <ol>
                        <li>
                            ...
                            Cek juga Tierlist kami <a href="{{ route('admin Tier List Genshin Page') }}" style="text-decoration:none;">disini</a> untuk mengetahui seberapa bagus karakter-karakter di Genshin Impact!<br/>
                        </li>
                        <br/>
                        <li>
                            Weapon Event Wish = SCAM ?!<br/>
                            Baca <a href="{{ route('Genshin admin Guide Gacha System Page') }}" style="text-decoration:none;">disini</a> untuk mengetahui system gacha Weapon Event Wish!<br/>
                        ...
                        <li>
                            ...
                            Baca <a href="{{ route('Genshin admin Guide Gacha System Page') }}" style="text-decoration:none;">disini</a> untuk mengetahui system gacha Character Event Wish & Standard Wish!<br/>
