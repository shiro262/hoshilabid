        ...
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            <div class="card-body" style="color:White; text-align:justify;">
                <p class="card-text">
                    ...
                    Untuk melihat penjelasan lengkap mengenai Elemental Reaction klik <a href="{{ route('Genshin admin Guide Elemental Reaction Page') }}" style="">disini</a><br/>
                    <br/>
                    ▣ Rekomendasi Team<br/>
                    <hr style="height:10px; border-width:5px; color:white;">
                    ...
                    <ul>
                        ...
                        <li style="margin-top:10px; margin-bottom:10px;">
                            ...
                            <a href="{{ route('View Character Genshin admin', [72]) }}">
                        ...
                        <li style="margin-top:10px; margin-bottom:10px;">
                            Nilou Bloom<br/>
                            <a href="{{ route('View Character Genshin admin', [51]) }}">
                        ...
                        <li style="margin-top:10px; margin-bottom:10px;">
                            ...
                            <a href="{{ route('View Character Genshin admin', [49]) }}">
