...
<div class="card text-center" style="background:black;">
    ...
    <br/><br/><br/><br/>
    <a href="{{ route('admin Genshin Forum Page') }}" class="btn btn-outline-light" style="float: center;"><</a><br/><br/>
    ...
    @endif
        <div style="display: flex; justify-content: center">
            @if ($forum->user_id == $user)
                <a href="{{ route('Edit Post Genshin admin Page', [$forum->id]) }}" class="btn btn-outline-primary">Edit</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="post" action="{{ route('Delete Post Genshin admin', [$forum->id]) }}">
                        @csrf
                        @method('delete')
        ...
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            <div class="card-body" style="color:White; text-align:justify;">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form action="{{route('Create Comment on Post Genshin admin', $forum->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
