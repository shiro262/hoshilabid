...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
    <div class="container">
        ...
        <ul class="navbar-nav me-auto">
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Home Genshin Impact') }}>Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Character Genshin Page') }}>Character</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Tier List Genshin Page') }}>Tier List</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Weapon Genshin Page') }}>Weapon</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Artifact Page') }}>Artifact</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Genshin Guide Page') }}>Guide</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Genshin News Page') }}>News</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('admin Genshin Forum Page') }}>Forum</a>
            </li>
        </ul>
