...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
    <div class="container">
        ...
        <ul class="navbar-nav me-auto">
            <li class="nav-item">
                <a class="nav-link active" href={{ route('Guest Home Honkai Impact') }}>Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href={{ route('Guest Character Page') }}>Character</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link active" href={{ route('Guest Stigmata Page') }}>Stigmata</a>
            </li>
            <li class="nav-item">
