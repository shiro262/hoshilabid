...
<div class="card text-center" style="background:black;">
    ...
    <div class="row row-cols-3">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Elements Guide View') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Combat Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Lightcone Guide View') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Simulated Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Forgotten Hall Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('Pure Fiction Guide View') }}">
