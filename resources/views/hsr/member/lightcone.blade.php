...
<div class="card text-center" style="background:black;">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
              <form class="d-flex my-2 my-lg-0" action="{{ route('Search Lightcone Member') }}">
                @if(isset($query))
    ...
    <div class="col d-flex justify-content-center">
        <table class="table w-75 p-3" style="border:1px solid white;">
            ...
            @foreach ($lightcone as $lc)
              <tr style="color: white; text-align: left;">
                <td>
                    <a href="{{ route('View Lightcone Member', [$lc->id]) }}">
