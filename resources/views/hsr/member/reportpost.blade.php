@section('title', 'Create Post - Honkai: Star Rail | HoshiLab')
...
<div class="card text" style="background:black;">
    ...
    <div style="display: flex; justify-content: center; color: white">
        <form method="post" enctype="multipart/form-data" action="{{ route('Create Report Post HSR Member', [$forum->id]) }}" style="width: 600px">
            @csrf
            <div class="mb-3">
