  ...
  <br/><br/>
    ...
    <div class="row row-cols-3 justify-content-md-center">
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('Member Guide Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href="{{ route('Member Character Honkai Star Rail Page') }}">
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('Member Tier List MOC Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('Member Tier List PF Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('Member Star Rail News Page') }}>
