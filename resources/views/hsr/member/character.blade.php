...
<div class="card text-center" style="background:black;">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
              <form class="d-flex my-2 my-lg-0" action="{{ route('Search Character Honkai Star Rail Member') }}">
                @if(isset($query))
    ...
    @else
        ...
        <a class="btn btn-transparent" href="{{ route('Member Character Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/All.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Fire Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Fire.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Ice Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Ice.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Imaginary Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Imaginary.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Lightning Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Lightning.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Physical Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Physical.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Quantum Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Quantum.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('member Character Wind Honkai Star Rail Page') }}" role="button">
    ...
    <div class="card-transparent" style="width: 18rem;">
        <a href="{{ route('View Character Honkai Star Rail Member', [$c->id]) }}">
