@section('title', $forum->title.' - Honkai: Star Rail | HoshiLab')
...
<div class="card text-center" style="background:black;">
    ...
    <br/><br/><br/><br/>
    <a href="{{ route('Member HSR Forum Page') }}" class="btn btn-outline-light" style="float: center;"><</a><br/><br/>
    ...
    @if ($forum->user_id == $user)
        <div style="display: flex; justify-content: center">
            <a href="{{ route('Edit Post HSR Member Page', [$forum->id]) }}" class="btn btn-outline-primary">Edit</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="post" action="{{ route('Delete Post HSR Member', [$forum->id]) }}">
                        @csrf
                        @method('delete')
    ...
    @else
        <div style="display: flex; justify-content: center">
            <a href="{{ route('Create Report HSR Member Page', [$forum->id]) }}" class="btn btn-outline-danger">Report</a>
        </div>
    @endif
    <br/>
    <div class="col d-flex justify-content-center">
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            @if ($forum->image != null)
                <img src="{{asset('storage/posthsrimage/'.$forum->image)}}" style="width: 35rem;">
            @endif
            <div class="card-body" style="color:White; text-align:justify;">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form action="{{route('Create Comment on Post HSR Member', $forum->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
