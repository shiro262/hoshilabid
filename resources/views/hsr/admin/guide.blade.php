...
<div class="card text-center" style="background:black;">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Characters Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Elements Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Path Guide View') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Combat Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Lightcone Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Relic Guide View') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Gacha Guide View') }}">
    ...
    <div class="row row-cols-3">
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Simulated Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Swarm Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Forgotten Hall Guide View') }}">
        ...
        <div class="card-transparent" style="width: 30rem;">
            <a href="{{ route('admin Pure Fiction Guide View') }}">
