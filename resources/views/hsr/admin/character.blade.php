...
<div class="card text-center" style="background:black;">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
              <form class="d-flex my-2 my-lg-0" action="{{ route('Search Character Honkai Star Rail admin') }}">
                @if(isset($query))
    ...
    {{-- <h6 class="fw-normal" style="letter-spacing: 1px; color:white;">
        Tambah Character <a href={{route('View Add Character HSR')}}>disini</a></h6>
    ...
    @else
        ...
        <a class="btn btn-transparent" href="{{ route('admin Character Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/All.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Fire Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Fire.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Ice Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Ice.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Imaginary Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Imaginary.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Lightning Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Lightning.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Physical Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Physical.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Quantum Honkai Star Rail Page') }}" role="button">
            <img class="card-img-top" src="{{asset('storage/image/element_hsr/Quantum.png')}}" style="width: 2rem;" alt="Card image cap">
        </a>
        <a class="btn btn-transparent" href="{{ route('admin Character Wind Honkai Star Rail Page') }}" role="button">
    ...
    <div class="card-transparent" style="width: 18rem;">
        <a href="{{ route('View Character Honkai Star Rail admin', [$c->id]) }}">
