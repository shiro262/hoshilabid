    ...
    @endif
        <div style="display: flex; justify-content: center">
            @if ($forum->user_id == $user)
                <a href="{{ route('Edit Post HSR admin Page', [$forum->id]) }}" class="btn btn-outline-primary">Edit</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form method="post" action="{{ route('Delete Post HSR admin', [$forum->id]) }}">
                        @csrf
                        @method('delete')
        ...
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            <div class="card-body" style="color:White; text-align:justify;">
                ...
                @if ($errors->any())
                 ...
                 @endif
                <form action="{{route('Create Comment on Post HSR admin', $forum->id)}}" method="POST">
                    @csrf
                    <div class="mb-3">
