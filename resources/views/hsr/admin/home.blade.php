  ...
  <br/><br/>
    ...
    <div class="row row-cols-3 justify-content-md-center">
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('admin Guide Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href="{{ route('admin Character Honkai Star Rail Page') }}">
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('admin Tier List MOC Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('admin Tier List PF Honkai Star Rail Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('admin Star Rail News Page') }}>
      ...
      <div class="card-transparent" style="width: 20rem;">
        <a href={{ route('admin HSR Forum Page') }}>
