        ...
        <div class="card-transparent w-50 p-3" style="border:1px solid white;">
            ...
            <div class="card-body" style="color:White; text-align:justify;">
                <p class="card-text">
                    ...
                    Opsi Terbaik:<br/>
                    <a href="{{ route('View Lightcone admin', [$chara->signlightcone->id]) }}">
                    ...
                    <br/><br/>
                    Opsi Alternatif:<br/>
                    <a href="{{ route('View Lightcone admin', [$chara->alt1lightcone->id]) }}">
                    ...
                    <br/><br/>
                    <a href="{{ route('View Lightcone admin', [$chara->alt2lightcone->id]) }}">
                    ...
                    <br/><br/>
                        ...
                        <hr style="height:10px; border-width:1px; color:white; margin-top:3px; margin-bottom:0px;">
                        Opsi 1:<br/>
                        <a href="{{ route('View Planar admin', [$chara->planaroption1->id]) }}">
                        ...
                        <br/>
                        Opsi 2:<br/>
                        <a href="{{ route('View Planar admin', [$chara->planaroption2->id]) }}">
